...
namespace PjlpCore.Migrations
{
    ...
    [Migration("20230206072949_TupoksiJabatanUpdate")]
    partial class TupoksiJabatanUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PjlpCore.Entity.TempTable", b =>
                {
            ...
            modelBuilder.Entity("PjlpCore.Entity.UserBidang", b =>
                {
                    b.Property<Guid>("UserBidangID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasKey("UserBidangID");

                    b.HasIndex("BidangID");

                    b.HasIndex("UserID");

                    b.ToTable("userbidang");
                });
            ...
            modelBuilder.Entity("PjlpCore.Entity.UserBidang", b =>
                {
                    b.HasOne("PjlpCore.Entity.Bidang", "Bidang")
                        .WithMany("UserBidangs")
                        .HasForeignKey("BidangID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PjlpCore.Entity.User", "User")
                        .WithMany("UserBidangs")
